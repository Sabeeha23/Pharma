...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div style="display:flex;">
        <div class="card" style="width: 20rem; margin:20px">
            <img src="Screenshot 2024-05-09 002303.png" class="card-img-top" alt="..." style="height: 300px;">
            <div class="card-body">
          ...
          <div class="card" style="width: 20rem; margin:20px">
            <img src="doremon.webp" class="card-img-top" alt="..." style="height: 300px;">
            <div class="card-body">
          ...
          <div class="card" style="width: 20rem; margin:20px">
            <img src="tom and jerry.jpg" class="card-img-top" alt="..." style="height: 300px;">
            <div class="card-body">
